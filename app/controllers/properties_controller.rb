class PropertiesController < ApplicationController
  ...
  def index
    @properties = Property.order(:description).page(params[:page])
  end
  ...
  private
    ...
    def property_params
      params.expect(property: [ :mnemonic, :loinc_code, :units_of_measure, :low_limit, :high_limit, :data_type, :description ])
    end
end
