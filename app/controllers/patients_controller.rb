class PatientsController < ApplicationController
  ...
  private
    ...
    def patient_params
      params.expect(patient: [ :first_name, :surname, :birth_date, :gender, :email, :phone, :mobile_phone, :internet, :address_line1, :address_line2, :municipality_id, :national_number ])
    end
end
