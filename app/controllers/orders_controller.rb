class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.expect(order: [ :placer_order_number, :filler_order_number, :priority, :order_status, :patient_id, :ordering_provider_id, :relevant_clinical_information, :order_call_back_phone, :receipt_time ])
    end
end
