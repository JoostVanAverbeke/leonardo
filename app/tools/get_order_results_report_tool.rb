...
class GetOrderResultsReportTool < ApplicationTool
    ...
    def call
      report_description = <<~REPORT_DESCRIPTOIN
        ...
        On the right side of the header, on the same position of the patients details, the report contains the ordering provider details. 
