...
# A gem that provides pre-configured MCP settings, specialized prompts, and templates for
# Rails development with AI assistants like Claude, GitHub Copilot, and other MCP-compatible tools.
gem "mcp-on-rails", "~> 0.3.2"
